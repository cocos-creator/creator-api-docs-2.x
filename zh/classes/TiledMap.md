...
##### Methods
  ...
  - [`setMapSize`](#setmapsize) 设置地图大小。
  - [`getTileSize`](#gettilesize) 获取地图背景中 tile 元素的大小。
  - [`setTileSize`](#settilesize) 设置地图背景中 tile 元素的大小。
  - [`getMapOrientation`](#getmaporientation) 获取地图方向。
  - [`setMapOrientation`](#setmaporientation) 设置地图方向。
  - [`getObjectGroups`](#getobjectgroups) 获取所有的对象层。
  - [`getProperties`](#getproperties) 获取地图的属性。
  - [`setProperties`](#setproperties) 设置地图的属性。
  - [`allLayers`](#alllayers) 返回包含所有 layer 的数组。
