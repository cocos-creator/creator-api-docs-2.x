...
##### Properties
  ...
  - [`type`](#type) `Sprite.SpriteType` 精灵渲染类型
  - [`fillType`](#filltype) `Sprite.FillType` 精灵填充类型，仅渲染类型设置为 cc.Sprite.SpriteType.FILLED 时有效。
  - [`fillCenter`](#fillcenter) `Vec2` 填充中心点，仅渲染类型设置为 cc.Sprite.SpriteType.FILLED 时有效。
  - [`fillStart`](#fillstart) `Number` 填充起始点，仅渲染类型设置为 cc.Sprite.SpriteType.FILLED 时有效。
  - [`fillRange`](#fillrange) `Number` 填充范围，仅渲染类型设置为 cc.Sprite.SpriteType.FILLED 时有效。
  - [`trim`](#trim) `Boolean` 是否使用裁剪模式
  - [`srcBlendFactor`](#srcblendfactor) `BlendFactor` 指定原图的混合模式
...
##### Methods
  ...
  - [`setInsetLeft`](#setinsetleft) 设置精灵左边框-用于九宫格。
  - [`getInsetLeft`](#getinsetleft) 获取精灵左边框
  - [`setInsetTop`](#setinsettop) 设置精灵上边框-用于九宫格。
  - [`getInsetTop`](#getinsettop) 获取精灵上边框。
  - [`setInsetRight`](#setinsetright) 设置精灵右边框-用于九宫格。
  - [`getInsetRight`](#getinsetright) 获取精灵右边框。
  - [`setInsetBottom`](#setinsetbottom) 设置精灵下边框-用于九宫格。
  - [`getInsetBottom`](#getinsetbottom) 获取精灵下边框。
